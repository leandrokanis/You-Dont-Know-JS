...
Clearly, `"foo"` is literally _not a_ `number`, but it's definitely not the `NaN` value either! This bug has been in JS since the very beginning \(over 19 years of _ouch_\).
