...
Luckily, smart folks like John-David Dalton and Mathias Bynens do understand these concepts, and wrote a statistically sound benchmarking tool called Benchmark.js \([http://benchmarkjs.com/](http://benchmarkjs.com/)\). So I can end the suspense by simply saying: "just use that tool."

I won't repeat their whole documentation for how Benchmark.js works; they have fantastic API Docs \([http://benchmarkjs.com/docs](http://benchmarkjs.com/docs)\) you should read. Also there are some great \([http://calendar.perfplanet.com/2010/bulletproof-javascript-benchmarks/](http://calendar.perfplanet.com/2010/bulletproof-javascript-benchmarks/)\) writeups \([http://monsur.hossa.in/2012/12/11/benchmarkjs.html](http://monsur.hossa.in/2012/12/11/benchmarkjs.html)\) on more of the details and methodology.
...
Some commonly cited examples \([https://github.com/petkaantonov/bluebird/wiki/Optimization-killers](https://github.com/petkaantonov/bluebird/wiki/Optimization-killers)\) for v8:
